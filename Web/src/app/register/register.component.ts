...
export class RegisterComponent implements OnInit {
    ...
    RegisterBtnClickEvent() {
        ...
        if (this.Validations()) {
            ...
            this.userService.checkuserexist(this.user).subscribe(
                (data) => {
                    if (data == false) {
    ...
    Validations() {
        ...
        if (
            ...
            this.alertService.error(
                'Password should contain at least 8 characters, an uppercase Character, a lowercase character,a number and a special character'
            )
            return false
        }
